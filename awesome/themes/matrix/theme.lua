--[[
    Matrix Awesome WM theme
    Author: Kajtek
    Source: https://github.com/Kajtek/config
--]]
...
local theme_dir  = config_dir .. "/themes/matrix"           -- path to this theme dir
local icons_dir  = theme_dir  .. "/icons"                   -- path to icons dir
local walls_dir  = theme_dir  .. "/wallpapers"              -- path to wallpapers dir

-- List of wallpapers
local wallpapers = {
		"1920x1200_matrix01.jpg",
		"1920x1200_matrix02.jpg",
		"1920x1200_matrix03.jpg",
		"1920x1200_matrix04.jpg",
		"1920x1200_matrix05.jpg",
        "1920x1200_matrix06.jpg",
        "1920x1200_matrix07.jpg"
}
